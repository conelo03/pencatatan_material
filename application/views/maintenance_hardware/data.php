                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php if (is_teknisi() && $u['status'] == 0) { ?>
                        <button class="btn btn-info" data-confirm="Anda yakin ingin menghapus data ini?|Data yang sudah dihapus tidak akan kembali." data-confirm-yes="document.location.href='<?= base_url('repair-maintenance-hardware/'.$u['id_maintenance']); ?>';"><i class="fa fa-wrench"></i> Repair</button>
                      <?php } ?>
                      </td>
                    </tr>
                    <?php endforeach;?>
